...
PenAccount = BankAccount("Pen", 1471521, 1093)
...
EraserAccount = BankAccount("Eraser", 5326165, 1151)
...
BlockyAccount = BankAccount("Blocky", 8381362, 1420)
...
MitchellAccount = BankAccount("Mitchell", 3141592, 0)
